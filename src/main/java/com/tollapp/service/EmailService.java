...
public class EmailService {
	...
	public void sendmail(String mailAddress, String otp) throws MailException, AddressException, MessagingException {
		
		SimpleMailMessage mail = new SimpleMailMessage();
		mail.setTo(mailAddress);
		mail.setFrom("resumebuilderdj2020@gmail.com");
		mail.setSubject("Email Verification OTP");
		mail.setText("Welcome to Fast Toll This is system generated OTP "+ otp+". Do not share this OTP with others. This One Time Password is valid for next 15 minutes.");
